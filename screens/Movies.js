...
const Movies = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.themoviedb.org/3/movie/popular?api_key=a7e32237cd1022116e2ea2bbef3bcfb3"
      )
      .then((res) => {
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("movename", { id: item.id, name: item.title })
            }
          >
            <View style={styles.listItem}>
              <Image
                source={{
                  uri: `https://image.tmdb.org/t/p/w220_and_h330_face${item.backdrop_path}`,
                }}
